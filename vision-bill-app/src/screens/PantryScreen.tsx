      ...
      {selectedItem && (
        <View style={[styles.detailDrawer, { backgroundColor: theme.card }]}>
          ...
          <View style={styles.manageRow}>
            ...
            <Pressable style={[styles.manageBtn, { backgroundColor: 'rgba(239, 68, 68, 0.1)' }]} onPress={handleDeleteItem}>
...
const styles = StyleSheet.create({
  ...
  detailDrawer: { position: 'absolute', bottom: 0, left: 0, right: 0, borderTopLeftRadius: 32, borderTopRightRadius: 32, padding: 24, paddingBottom: 40, elevation: 20, shadowColor: '#000', shadowOffset: { width: 0, height: -4 }, shadowOpacity: 0.1, shadowRadius: 10 },
